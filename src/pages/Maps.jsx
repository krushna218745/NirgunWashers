      ...
      <section className="maps-content">
        <div className="maps-container">
          ...
          <div className="location-info">
            ...
            <p className="location-address">{businessLocation.address}</p>
            ...
            <div className="contact-details">
              <div className="detail-item">
                ...
                <div>
                  ...
                  <p><a href="tel:+919876543210">{t.contact.phoneValue}</a></p>
                </div>
              </div>
              <div className="detail-item">
                <div className="detail-icon"></div>
                <div>
                  ...
                  <p><a href="mailto:info@nirgunwashers.com">{t.contact.emailValue}</a></p>
                </div>
              </div>
              <div className="detail-item">
                <div className="detail-icon"></div>
